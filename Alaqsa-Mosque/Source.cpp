...
//variables to save bmps
int bottom_of_the_building ;
...
int InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
	...
	glEnable(GL_TEXTURE_2D);
		bottom_of_the_building = LoadTexture("bottom.bmp",255);
...
int DrawGLScene(GLvoid)									// Here's Where We Do All The Drawing
{
	...
	MyCamera.Render();
	Key(keys, 0.3);
	//primitivedrawer.DrawQuadWithTexture(Point(0,0,0),Point(5,0,0),Point(5,0,-5),Point(0,0,-5),bottom_of_the_building);
	return TRUE;
}
